...
export function EducationalPrograms() {
  ...
  const activities: Activity[] = [
    {
      title: 'Factoring Solutions to the Management of Stroke Care in the Settings of Secondary Prevention and AF',
      icon: <BookOpen size={16} className="text-blue-700" />,
      href: 'https://reachmd.com/programs/cme/factoring-solutions-to-the-management-of-stroke-care-in-the-settings-of-secondary-prevention-and-af/29099/',
      category: 'CME Activity • 90 min',
      imageUrl: '/act1.png'
    },
    {
      title: 'Driving Progress in Cardiology: Exploring the Role of FXI in Acute Coronary Syndromes & Beyond',
      icon: <Heart size={16} className="text-blue-700" />,
      href: 'https://reachmd.com/programs/cme/driving-progress-in-cardiology-exploring-the-role-of-fxi-in-acute-coronary-syndromes-beyond/32980/',
      category: 'CME Activity • 60 min',
      imageUrl: '/act2.png'
    }
  ]
